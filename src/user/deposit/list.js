...
const DepositList = () => {
  return (
    <>
      ...
      <div className="container">
        ...
        <ul className="collection row">
          <li className="collection-item app-py-1 ">
            <div className="row app-list-link">
      ...
      <div className="fixed-action-btn"><Link title="New Deposit" className="btn-floating btn-large" id="btn" to="/user/deposits/fund/step1"><i className="large material-icons notranslate">add</i></Link>
        <div className="tap-target-wrapper" style={{ "right": "-362px", "bottom": "-262px", "position": "fixed" }}>
          ...
          <div className="tap-target-wave" style={{ "top": "344px", "left": "344px", "width": "112px", "height": "112px" }}><Link title="New Deposit" className="btn-floating btn-large tap-target-origin" to="/user/deposits/fund/step1"><i className="large material-icons notranslate">add</i></Link></div>
        </div>
      </div >
    </>
  )
