            ...
            <section class="row center">
                <div class="col l4 offset-l4 s12">
                    <div class="card-panel">
                        ...
                        <Link class="btn" to="/user/deposits/upload-proof/23">UPLOAD PAYMENT PROOF</Link>
                        <br />
                        <Link class="btn btn-secondary" to="/user/deposits/list">WAIT FOR CONFIRMATION</Link>
                    </div>
                    <ToastContainer />
                </div>
            </section>
