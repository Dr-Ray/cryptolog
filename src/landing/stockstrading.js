                ...
                <div className="container">
                    <div className="row">
                        <div className="col-12">
                            <h6 className="d-none">Stocks Trading</h6>
                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col-12 mb-2">
                                <h1 className="fw-bold mb-2">Stocks <span className="text-highlight">Trading</span></h1>
                            </div>
                        </div>
                                        ...
                                        <div className="card">
                                            <div className="card-body p-3 p-md-5">
                                                ...
                                                <p>
                                                    ...
                                                    Stock Trading Risk Assessment<br />
...
export default StockTradingLanding
